    ...
    <footer className="bg-slate-950 text-slate-450 py-16 border-t border-slate-900 relative overflow-hidden">
      <div className="container mx-auto px-6 max-w-6xl relative z-10">
        <div className="grid md:grid-cols-3 gap-12 lg:gap-24 mb-16">
          ...
          {/* Contact Col */}
          <div>
            <h4 className="text-white font-bold mb-6 tracking-wide uppercase text-sm">Canales de Contacto</h4>
            <ul className="space-y-3.5 text-xs">
              ...
              <li>
                ...
                >
                  <span className="w-8 h-8 rounded-full bg-[#25D366]/15 flex items-center justify-center text-[#25D366] border border-[#25D366]/20 shrink-0 group-hover:bg-[#25D366] group-hover:text-white transition-all group-hover:scale-105 shadow-md">
                  ...
                  <div>
                    <span className="font-bold text-slate-200 group-hover:text-[#25D366] transition-colors block leading-tight">
                      WhatsApp Comercial
                    </span>
                    <span className="text-[10px] text-slate-400 font-medium">Cotizaciones corporativas (No CVs)</span>
                  </div>
                </a>
              </li>
              ...
              <li className="flex items-center gap-2.5 text-slate-350">
                ...
                <div>
                  <a href="mailto:presupuestos@arianaservicios.com.ar" className="hover:text-brand-400 font-semibold text-slate-300 transition-colors block">
                    presupuestos@arianaservicios.com.ar
                  </a>
                  <span className="text-[10px] text-slate-450">Cotizaciones y contrataciones</span>
                </div>
              </li>
              ...
              <li className="flex items-center gap-2.5 text-slate-350">
                ...
                <div>
                  <a href="mailto:ventas@arianaservicios.com.ar" className="hover:text-teal-400 font-semibold text-slate-300 transition-colors block">
                    ventas@arianaservicios.com.ar
                  </a>
                  <span className="text-[10px] text-slate-450">Insumos y tienda de productos</span>
                </div>
              </li>
              ...
              <li className="flex items-center gap-2.5 text-slate-350">
                ...
                <div>
                  <a href="mailto:cv@arianaservicios.com.ar" className="hover:text-purple-400 font-semibold text-slate-300 transition-colors block">
                    cv@arianaservicios.com.ar
                  </a>
                  <span className="text-[10px] text-slate-450">Postulaciones laborales y CVs</span>
                </div>
              </li>

              {/* 4. Info */}
              <li className="flex items-center gap-2.5 text-slate-350">
                <span className="text-slate-400 font-bold text-sm">ℹ️</span>
                <div>
                  <a href="mailto:info@arianaservicios.com.ar" className="hover:text-brand-400 font-semibold text-slate-300 transition-colors block">
                    info@arianaservicios.com.ar
                  </a>
                  <span className="text-[10px] text-slate-450">Consultas generales</span>
                </div>
              </li>
